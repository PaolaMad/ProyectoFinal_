  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col justify-center items-center p-3 w-full h-full overflow-y-scroll md:h-screen">
        <h1 className="text-3xl text-white font-bold mb-6">Ajustes de Perfil</h1>

        <form
          className="bg-blue-ligth rounded-md w-4/12 p-6">

          <div className="flex flex-col mb-4">
            <label className="text-white font-semibold mb-2">Cambiar Correo Electronico</label>
            <input
          ...
          <div className="flex flex-row justify-between mb-4">
            <div className="flex flex-col w-1/2 mr-2">
              <label className="text-white font-semibold mb-2">Cambiar Nombre</label>
              <input
                className="border-2 w-full p-2 placeholder-gray-600 rounded-md"
                type="text"
                placeholder="Nombre" />
            ...
            <div className="flex flex-col w-1/2 mr-2">
              <label className="text-white font-semibold mb-2">Cambiar Apellido</label>
              <input
                className="border-2 w-full p-2 placeholder-gray-600 rounded-md"
                type="text"
          ...
          <div className="flex flex-col mb-4 relative mt-3">
            <label className="text-white font-semibold mb-2">Cambiar Contraseña</label>
            <input
          ...
          <div className="flex flex-col mb-4 relative mt-3">
            <label className="text-white font-semibold mb-2">Confirmar Contraseña</label>
            <input
              className="w-full border border-gray-600 px-3 py-2 rounded-lg placeholder-gray-600"
              type={showPassword ? "text" : "password"}
